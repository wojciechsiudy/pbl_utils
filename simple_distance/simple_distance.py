...
def display_info():
    ...
    for distance in distances:
        print(f"Distance of {distance[3]:.10f} in degrees is equal to {geodesic((distance[0],distance[1]),(distance[2],distance[3])).m} in meters")
...
def calculate_distance(args : list[float]):
    ...
    print(f"Distance between {args} is equal to {geodesic((args[0],args[1]),(args[2],args[3])).m:.15f} m")
